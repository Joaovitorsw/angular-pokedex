...
declare module 'pokedex-promise-v2' {
    ...
    class PokeAPI {
        ...
        getBerriesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getBerriesFirmnessList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        /** @deprecated will be removed on a future version. Use {@link getBerriesFirmnessList} instead */
        getBerriesFirmnesssList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getBerriesFlavorsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getContestTypesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getContestEffectsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getSuperContestEffectsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEncounterMethodsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEncounterConditionsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEncounterConditionValuesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEvolutionChainsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEvolutionTriggersList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGenerationsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        /** @deprecated will be removed on a future version. Use {@link getPokedexList} instead */
        getPokedexsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokedexList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getVersionsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getVersionGroupsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemAttributesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemCategoriesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemFlingEffectsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemPocketsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMachinesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getMovesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveAilmentsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveBattleStylesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveCategoriesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveDamageClassesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveLearnMethodsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveTargetsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLocationsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLocationAreasList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPalParkAreasList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getRegionsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getAbilitiesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getCharacteristicsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEggGroupsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGendersList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGrowthRatesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getNaturesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokeathlonStatsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonColorsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonFormsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonHabitatsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonShapesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonSpeciesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getStatsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getTypesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLanguagesList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEndpointsList(interval?: PokeAPI.ListEndpointOptions, callback?: (result: any, error?: any) => any): Promise<PokeAPI.EndpointsList>;
    }
