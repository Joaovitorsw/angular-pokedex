...
declare module 'pokedex-promise-v2' {
    ...
    class PokeAPI {
        ...
        getBerriesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getBerriesFirmnessList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        /** @deprecated will be removed on a future version. Use {@link getBerriesFirmnessList} instead */
        getBerriesFirmnesssList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getBerriesFlavorsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getContestTypesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getContestEffectsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getSuperContestEffectsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEncounterMethodsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEncounterConditionsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEncounterConditionValuesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEvolutionChainsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEvolutionTriggersList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGenerationsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        /** @deprecated will be removed on a future version. Use {@link getPokedexList} instead */
        getPokedexsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokedexList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getVersionsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getVersionGroupsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemAttributesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemCategoriesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemFlingEffectsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getItemPocketsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMachinesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getMovesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveAilmentsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveBattleStylesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveCategoriesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveDamageClassesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveLearnMethodsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getMoveTargetsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLocationsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLocationAreasList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPalParkAreasList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getRegionsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getAbilitiesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getCharacteristicsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.APIResourceList, error?: any) => any): Promise<PokeAPI.APIResourceList>;
        getEggGroupsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGendersList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getGrowthRatesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getNaturesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokeathlonStatsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonColorsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonFormsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonHabitatsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonShapesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getPokemonSpeciesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getStatsList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getTypesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getLanguagesList(interval?: PokeAPI.EndpointsList, callback?: (result: PokeAPI.NamedAPIResourceList, error?: any) => any): Promise<PokeAPI.NamedAPIResourceList>;
        getEndpointsList(interval?: PokeAPI.EndpointsList, callback?: (result: any, error?: any) => any): Promise<PokeAPI.EndpointsList>;
    }
